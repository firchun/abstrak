                ...
                <div class="col-lg-6">
                    <div class="difference-of-us-item p-3 rounded mr-0 me-lg-4">
                        <div class="d-block d-sm-flex align-items-center m-2">
                            <div class="icon me-4 mb-4 mb-sm-0"> <i class="fas fa-file mt-4" style="font-size:36px"></i>
                            </div>
                            <div class="block">
                                <h3 class="mb-3">File Abstrak</h3>
                                <p class="mb-0">Mahasiswa/mahasiswi diwajibkan untuk menyiapkan file abstrak yang telah di
                                    scan dengan format PDF</p>
                            </div>
                        </div>
                    </div>
                    <div class="difference-of-us-item p-3 rounded mr-0 me-lg-4">
                        <div class="d-block d-sm-flex align-items-center m-2">
                            ...
                            <div class="block">
                                ...
                                <p class="mb-0">Melampirkan bukti pembayaran yang telah di foto ataupun di scan dan siap
                                    diupload dalam bentuk format PDF</p>
                            </div>
                        </div>
                    </div>
                    <div class="difference-of-us-item p-3 rounded mr-0 me-lg-4">
                        <div class="d-block d-sm-flex align-items-center m-2">
                            ...
                            <div class="block">
                                <h3 class="mb-3">Lembar Pengesahan</h3>
                                <p class="mb-0">Melampirkan Lembar pengesahan yang telah di scan dalam bentuk PDF</p>
                            </div>
                        </div>
                    </div>
